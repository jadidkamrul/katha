<section id="main-content" class=" ">
    ...
    <div class="row">
    <form action ="<?php echo base_url(); ?>admin/Users/editUser" method="post" id="userform" enctype="multipart/form-data">
        ...
        <div class="col-xs-12 col-sm-9 col-md-8">
            ...
            <div class="form-group">
                ...
                <div class="controls">
                    <input type="text" name="date_of_birth" value="<?php echo $user['date_of_birth']; ?>" class="form-control datepicker" data-format="mm/dd/yyyy" >
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <span class="desc"></span>
                    <select name="gender" class="form-control">
                        <option value="v"><?php echo $user['gender']; ?></option>
            ...
            <div class="form-group">
                ...
                <div class="controls">
                    <textarea name="user_details"  class="form-control autogrow" cols="5" >
                ...
                <div class="form-group">
                    ...
                    <span class="desc"></span>
                    <div class="controls">
                        <textarea name="user_address" class="form-control autogrow" cols="5" >
                            <?php echo $user['user_details']; ?>
                        </textarea>
                    </div>
                </div>
