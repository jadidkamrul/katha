            ...
            <ul class="info-menu right-links list-inline list-unstyled">
                <li class="profile">
                    ...
                    <ul class="dropdown-menu profile animated fadeIn">
                        <li>
                            <a href="<?php echo base_url(); ?>Seller/settings">
    ...
    <div class="page-sidebar-wrapper" id="main-menu-wrapper">
        ...
        <div class="profile-info row">
            ...
            <div class="profile-details col-xs-8">
                ...
                <p class="profile-title">Seller</p>
            </div>
        </div>
        <!-- USER INFO - END -->
        <ul class='wraplist'>
                    ...
                    <span class="title">Products</span>
                        ...
                        <ul class="sub-menu" >
                            <li>
                            <a class="" href="<?php echo base_url(); ?>seller/products/add_product" >Add Product</a>
                            </li>
                            <li>
                            <a class="" href="<?php echo base_url(); ?>seller/products" >All Products</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <span class="title">Orders</span>
                        ...
                        <ul class="sub-menu" >
                            <li><a class="" href="<?php echo base_url(); ?>seller/Order/allorder" >All Orders</a></li>
                        </ul>
                    </li>
