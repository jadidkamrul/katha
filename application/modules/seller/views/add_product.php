...
<?php if ($this->session->flashdata('successmsg')) { ?>
    ...
    <div class="row">
        <form action ="<?php echo base_url(); ?>seller/products/add" id="productform" method="post" enctype="multipart/form-data">
                    ...
                    <select class="form-control" name="category">
                        <option value=""></option>
                            <?php foreach ($category as $categories) { ?>
                              <option value="<?php echo $categories['cat_id']; ?>" ><?php echo $categories['catname']; ?></option>
                            <?php  } ?>
                    </select>
                </div>
