    ...
    <div class="col-xs-12">
        <section class="box ">
            ...
            <div class="content-body">
                <div class="row">
                <form action ="<?php echo base_url() ?>admin/Settings/userUpdate" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-xs-12 col-sm-9 col-md-8">
                        ...
                        <div class="form-group">
                            ...
                            <span class="desc"></span>
                            <div class="controls">
                                <input type="text" value="<?php echo $info['phone']; ?>" class="form-control">
                            </div>
                        </div>
