...
<section>
    ...
    <?php if ($this->session->flashdata('successmsg')) { ?>
        ...
        <div class="col-md-6 col-md-offset-3 border">
            <div class="title row"><center>Registration ( New Designer )</center></div>
            <section class="box ">
                <div class="content-body">
                    <div class="row">
                        <form action ="<?php echo base_url(); ?>/login/designer_add" method="post" enctype="multipart/form-data">
