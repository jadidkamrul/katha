<section id="main-content" class=" ">
    ...
    <div class="row">
    <form action ="<?php echo base_url(); ?>seller/products/edit_products" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <textarea name="details" class="form-control autogrow" cols="5" ><?php echo $product['product_desc'] ?></textarea>
                            </div>
                        </div>
