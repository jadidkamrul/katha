<section id="main-content" class=" ">
        ...
        <div class="page-title">
            ...
            <div class="pull-right hidden-xs">
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <strong>Update Design Information</strong>
                    </li>
                </ol>
            </div>
        </div>
    ...
    <section class="box ">
	    ...
	    <div class="row">
		    <form action ="<?php echo base_url(); ?>designer/Designs/edit_designdata" method="post" id="designform" enctype="multipart/form-data">
		        <div class="col-xs-12 col-sm-9 col-md-8">

                <?php foreach ($designdata as $designs){?>
                <input type="hidden" name="id" value="<?php echo $this->uri->segment(4); ?>">
		            ...
		            <div class="form-group">
		                ...
		                <div class="controls">
		                    <input type="text" name="designname" value="<?php echo $designs['title']; ?>" class="form-control" id="field-15970">
		                </div>
		            </div>
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <span class="desc"></span>
                        <div class="controls">
                            <input type="text" name="price" value="<?php echo $designs['price']; ?>" class="form-control" id="field-15970">
                        </div>
                    </div>
