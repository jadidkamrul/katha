...
<section>
    ...
    <?php } ?>
        ...
        <div class="col-md-6 col-md-offset-3 border">
                     <div class="title row">Designer Login with User and Password</div>
            <section class="box ">
                <div class="content-body">
                    <div class="row">
 							<form action="<?php echo base_url(); ?>designer/login/authentication" method="post">
                                <div class="form-group">
                                    <label class="form-label form_lable" for="field-15970">Designer Email</label>
                                ...
                                <div class="form-group">
                                    <label class="form-label form_lable" for="field-15970">Designer Pass</label>
                                    <span class="desc"></span>
                                    <div class="controls">
        ...
        <div class="col-md-6 col-md-offset-4"></br>
        	<a class="btn btn-success btn-lg" href="<?php echo base_url(); ?>login/designerAdd"><i class="icon-edit icon-white"></i>Click Here For Registration</a>
        </div>
